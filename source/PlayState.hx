...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Try tutorial', 0.2], //From 0% to 19%
		['baby', 0.4], //From 20% to 39%
		['dumb', 0.5], //From 40% to 49%
		['-1000000000 social credit', 0.6], //From 50% to 59%
		['big stupid', 0.69], //From 60% to 68%
		['trash', 0.7], //69%
		['v good', 0.8], //From 70% to 79%
		['cool', 0.9], //From 80% to 89%
		['YEAH!', 1], //From 90% to 99%
		['ARIANA GRANDE PEQUENA', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				case 'wiik1d': //Week 1
				var wiik1d:BGSprite = new BGSprite('wiik1d', -600, -200, 0.9, 0.9);
				add(wiik1d);
		...
		timeTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.BLUE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.RED);
